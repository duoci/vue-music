<template>
  <div class="SearchAlbum">
    ...
    <list-card :listCardData="searchAlbumList" @clickListCardItem="clickListCardItem"></list-card>
    <!-- 分页 -->
    <div class="page" v-if="searchAlbumList.length != 0">
      <el-pagination background layout="prev, pager, next" :total="albumCount" small :page-size="30" :current-page="currentPage" @current-change="pageChange">
      </el-pagination>
    </div>
  </div>
</template>
